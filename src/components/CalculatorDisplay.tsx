...
const CalculatorDisplay: React.FC<CalculatorDisplayProps> = ({ display }) => {
  ...
  return (
    <div className={`rounded-2xl p-3 md:p-6 shadow-inner border transition-colors duration-300 ${
      theme === 'dark'
      ...
      {/* Affichage Unifié */}
      <div className={`text-3xl md:text-4xl lg:text-5xl font-bold font-mono min-h-[2.5rem] md:min-h-[4rem] rounded-lg px-3 md:px-4 py-2 md:py-3 border shadow-sm flex items-center justify-end overflow-hidden transition-colors duration-300 ${
        theme === 'dark'
