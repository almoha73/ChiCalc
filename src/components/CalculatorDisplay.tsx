...
const CalculatorDisplay: React.FC<CalculatorDisplayProps> = ({ display }) => {
  ...
  return (
    <div className={`rounded-2xl p-3 sm:p-4 lg:p-6 shadow-inner border transition-colors duration-300 ${
      resolvedTheme === 'dark'
      ...
      {/* Affichage Unifié */}
      <div className={`text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold font-mono min-h-[2.75rem] sm:min-h-[3rem] lg:min-h-[4rem] rounded-lg px-3 sm:px-4 py-3 sm:py-4 border shadow-sm flex items-center justify-end overflow-hidden transition-colors duration-300 ${
        resolvedTheme === 'dark'
