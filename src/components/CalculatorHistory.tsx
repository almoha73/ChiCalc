          ...
          <div className="p-4 space-y-3">
            {history.map((item) => (
              <div
                ...
                className={`p-4 rounded-xl cursor-pointer transition-all duration-200 hover:scale-105 border ${
                  resolvedTheme === 'dark'
                    ? 'bg-palette-3/20 hover:bg-palette-3/30 border-palette-4/20'
                    : 'bg-palette-5/20 hover:bg-palette-5/30 border-palette-4/20'
                }`}
              >
