...
const Calculator: React.FC = () => {
  ...
  return (
    <>
      <div className="w-full max-w-md mx-auto h-full md:h-auto flex flex-col md:block">
        <div className={`backdrop-blur-sm rounded-3xl shadow-2xl border overflow-hidden transition-colors duration-300 flex-1 md:flex-none flex flex-col md:block ${
          theme === 'dark'
          ...
          <div className={`relative p-3 md:p-6 border-b transition-colors duration-300 flex-shrink-0 ${
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className={`text-xl md:text-2xl font-bold mb-1 md:mb-2 transition-colors duration-300 ${
              ...
              <div className="flex items-center gap-2 md:gap-4">
                <button
                  ...
                  className={`p-2 md:p-3 rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-sm hover:shadow-md relative ${
                    theme === 'dark'
                ...
                >
                  ...
                  {history.length > 0 && (
                    <div className={`absolute -top-1 -right-1 w-5 h-5 md:w-6 md:h-6 rounded-full text-xs font-bold flex items-center justify-center border-2 transition-colors duration-300 ${
                      theme === 'dark'
                ...
                <ThemeToggle />
                <ChihuahuaIllustration className="w-16 h-16 md:w-20 md:h-20 opacity-90" />
              </div>
            </div>
          </div>
