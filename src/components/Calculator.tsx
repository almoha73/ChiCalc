...
const Calculator: React.FC = () => {
  ...
  return (
    <div className="w-full h-full max-w-full max-h-full flex flex-col items-center justify-center">
      <div className="w-full h-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-3xl mx-auto p-0 sm:p-2 md:max-h-[600px]" style={{height: '100dvh'}}>
        {/* Calculatrice Principale */}
        <div className={`h-full flex flex-col backdrop-blur-sm rounded-2xl shadow-2xl border overflow-hidden transition-colors duration-300 ${
          resolvedTheme === 'dark'
            ? 'bg-palette-2/90 border-palette-3/30'
            : 'bg-white/95 border-palette-5/30'
        }`}>
          {/* En-tête avec Chihuahua, Bouton Thème et Historique */}
          <div className={`relative p-2 sm:p-4 lg:p-6 border-b transition-colors duration-300 flex-shrink-0 ${
            resolvedTheme === 'dark'
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className={`text-base sm:text-xl lg:text-2xl font-bold mb-1 lg:mb-2 transition-colors duration-300 ${
              ...
              <div className="flex items-center gap-2 sm:gap-3 lg:gap-4">
                ...
                <ChihuahuaIllustration className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 opacity-90" />
              </div>
            </div>
          </div>
          ...
          {/* Boutons */}
          <div className="p-2 sm:p-3 lg:p-4 pt-1 flex-1 min-h-0">
            <CalculatorButtons 
