  ...
  return (
    <>
      <div className="w-full max-w-sm sm:max-w-md mx-auto">
        <div className={`backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl border overflow-hidden transition-colors duration-300 ${
          theme === 'dark'
            ? 'bg-palette-2/90 border-palette-3/30'
            : 'bg-white/95 border-palette-5/30'
        }`}>
          {/* En-tête avec Chihuahua et Boutons */}
          <div className={`relative p-3 sm:p-6 border-b transition-colors duration-300 ${
            theme === 'dark'
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className={`text-lg sm:text-2xl font-bold mb-1 sm:mb-2 transition-colors duration-300 ${
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <button
                  ...
                  className={`p-2 sm:p-3 rounded-lg sm:rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-sm hover:shadow-md relative ${
                    theme === 'dark'
                ...
                >
                  ...
                  {history.length > 0 && (
                    <div className={`absolute -top-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 rounded-full text-xs font-bold flex items-center justify-center border-2 transition-colors duration-300 ${
                      theme === 'dark'
                ...
                <ThemeToggle />
                <ChihuahuaIllustration className="w-12 h-12 sm:w-20 sm:h-20 opacity-90" />
              </div>
            </div>
          </div>
